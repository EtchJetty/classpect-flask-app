!(function (e, t) {
  ...
  function r(e) {
    var t = (Ne[e] = {});
    return (
      ue.each(e.match(ce) || [], function (e, n) {
        t[n] = !0;
      }),
      t
    );
  ...
  function i(e, n, r, i) {
    if (ue.acceptData(e)) {
      ...
      if ((f && c[f] && (i || c[f].data)) || !u || r !== t)
        return (
          f || (l ? (e[s] = f = Z.pop() || ue.guid++) : (f = s)),
          c[f] || ((c[f] = {}), l || (c[f].toJSON = ue.noop)),
          ("object" == typeof n || "function" == typeof n) &&
            (i
              ? (c[f] = ue.extend(c[f], n))
              : (c[f].data = ue.extend(c[f].data, n))),
          (o = c[f]),
      ...
      if (u[l]) {
        if (t && (o = n ? u[l] : u[l].data)) {
          ue.isArray(t)
            ...
            : t in o
            ? (t = [t])
            : ((t = ue.camelCase(t)), (t = t in o ? [t] : t.split(" ")));
        ...
        (n || (delete u[l].data, s(u[l]))) &&
          (a
            ? ue.cleanData([e], !0)
            : ue.support.deleteExpando || u != u.window
            ? delete u[l]
            : (u[l] = null));
      }
    }
  ...
  function b(e, n) {
    ...
    if (!a)
      for (a = [], r = e.childNodes || e; null != (i = r[o]); o++)
        !n || ue.nodeName(i, n) ? a.push(i) : ue.merge(a, b(i, n));
  ...
  function N(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
      (r = e[a]),
        r.style &&
          ((o[a] = ue._data(r, "olddisplay")),
          (n = r.style.display),
          t
            ? (o[a] || "none" !== n || (r.style.display = ""),
              "" === r.style.display &&
                w(r) &&
                (o[a] = ue._data(r, "olddisplay", S(r.nodeName))))
            : o[a] ||
              ((i = w(r)),
              ((n && "none" !== n) || !i) &&
                ue._data(r, "olddisplay", i ? n : ue.css(r, "display"))));
    for (a = 0; s > a; a++)
      (r = e[a]),
        r.style &&
  ...
  function k(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += ue.css(e, n + Nt[o], !0, i)),
        r
          ? ("content" === n && (a -= ue.css(e, "padding" + Nt[o], !0, i)),
            "margin" !== n &&
              (a -= ue.css(e, "border" + Nt[o] + "Width", !0, i)))
          : ((a += ue.css(e, "padding" + Nt[o], !0, i)),
            "padding" !== n &&
              (a += ue.css(e, "border" + Nt[o] + "Width", !0, i)));
    return a;
  }
  function E(e, t, n) {
    var r = !0,
      ...
      o = ct(e),
      a =
        ue.support.boxSizing && "border-box" === ue.css(e, "boxSizing", !1, o);
    if (0 >= i || null == i) {
      if (
        ((i = ft(e, t, o)),
  ...
  function B(e, t) {
    ue.each(t, function (t, n) {
      for (
        var r = (on[t] || []).concat(on["*"]), i = 0, o = r.length;
        o > i;
        i++
      )
  ...
  function P(e, t, n) {
    ...
    return (
      ...
      ue.fx.timer(ue.extend(u, { elem: e, anim: l, queue: l.opts.queue })),
      l
    ...
    n.queue ||
      ...
      1 === e.nodeType &&
        ...
        "inline" === ue.css(e, "display") &&
          "none" === ue.css(e, "float") &&
          (ue.support.inlineBlockNeedsLayout && "inline" !== S(e.nodeName)
            ? (d.zoom = 1)
  ...
  function I(e, t) {
    ...
    for (t = t ? 1 : 0; 4 > i; i += 2 - t)
      (n = Nt[i]), (r["margin" + n] = r["padding" + n] = e);
  ...
  (ue.fn = ue.prototype =
          ...
          if (null != (o = arguments[u]))
            for (i in o)
              (e = s[i]),
                (r = o[i]),
                s !== r &&
                  (c && r && (ue.isPlainObject(r) || (n = ue.isArray(r)))
                    ? (n
                        ? ((n = !1), (a = e && ue.isArray(e) ? e : []))
                        : (a = e && ue.isPlainObject(e) ? e : {}),
                      (s[i] = ue.extend(c, a, r)))
                    : r !== t && (s[i] = r));
        return s;
      }),
    ue.extend({
      noConflict: function (t) {
        return (
          e.$ === ue && (e.$ = Q), t && e.jQuery === ue && (e.jQuery = G), ue
        );
      },
      isReady: !1,
      readyWait: 1,
      ...
      ready: function (e) {
        if (e === !0 ? !--ue.readyWait : !ue.isReady) {
          ...
          (ue.isReady = !0),
            (e !== !0 && --ue.readyWait > 0) ||
              (X.resolveWith(Y, [ue]),
              ue.fn.trigger && ue(Y).trigger("ready").off("ready"));
        }
      },
      ...
      parseJSON: function (n) {
        return e.JSON && e.JSON.parse
          ...
          : "string" == typeof n &&
            ((n = ue.trim(n)),
            n && he.test(n.replace(me, "@").replace(ye, "]").replace(ge, "")))
          ? Function("return " + n)()
      ...
      makeArray: function (e, t) {
        ...
        return (
          null != e &&
            (n(Object(e))
              ? ue.merge(r, "string" == typeof e ? [e] : e)
              : ne.call(r, e)),
          r
        );
      },
    ...
    (ue.ready.promise = function (t) {
      if (!X)
        if (((X = ue.Deferred()), "complete" === Y.readyState))
          setTimeout(ue.ready);
  ...
  (ue.Callbacks = function (e) {
    ...
    var n,
      ...
      f = function (t) {
        for (
          i = e.memory && t, o = !0, s = u || 0, u = 0, a = l.length, n = !0;
          l && a > s;
          s++
        )
  ...
  ue.extend({
    ...
    hasData: function (e) {
      return (
        (e = e.nodeType ? ue.cache[e[ue.expando]] : e[ue.expando]), !!e && !s(e)
      );
    },
    data: function (e, t, n) {
      return i(e, t, n);
    ...
    ue.fn.extend({
      data: function (e, n) {
        ...
        if (e === t) {
          if (
            this.length &&
            ((u = ue.data(o)), 1 === o.nodeType && !ue._data(o, "parsedAttrs"))
          ) {
            for (r = o.attributes; r.length > s; s++)
              (i = r[s].name),
                i.indexOf("data-") ||
                  ((i = ue.camelCase(i.slice(5))), a(o, i, u[i]));
  ...
  ue.fn.extend({
    ...
    toggleClass: function (e, t) {
      ...
      return ue.isFunction(e)
        ...
        : this.each(function () {
            if ("string" === n)
              for (
                var i, o = 0, a = ue(this), s = t, u = e.match(ce) || [];
                (i = u[o++]);
    ...
    val: function (e) {
      ...
      return arguments.length
        ...
        : o
        ? ((r = ue.valHooks[o.type] || ue.valHooks[o.nodeName.toLowerCase()]),
          r && "get" in r && (n = r.get(o, "value")) !== t
            ? n
            : ((n = o.value),
              "string" == typeof n ? n.replace(je, "") : null == n ? "" : n))
        : void 0;
    },
  }),
    ue.extend({
        ...
        if (e && 3 !== s && 8 !== s && 2 !== s)
          return typeof e.getAttribute === V
            ...
            : ((o = 1 !== s || !ue.isXMLDoc(e)),
              o &&
                ((n = n.toLowerCase()),
                (i = ue.attrHooks[n] || (He.test(n) ? Se : Ee))),
              r === t
        ...
        if (o && 1 === e.nodeType)
          for (; (n = o[i++]); )
            (r = ue.propFix[n] || n),
              He.test(n)
                ? !Me && qe.test(n)
                  ? (e[ue.camelCase("default-" + n)] = e[r] = !1)
                  : (e[r] = !1)
                : ue.attr(e, n, ""),
        ...
        tabIndex: {
          get: function (e) {
            ...
            return n && n.specified
              ? parseInt(n.value, 10)
              : De.test(e.nodeName) || (Le.test(e.nodeName) && e.href)
              ? 0
              : t;
          },
        },
      ...
      set: function (e, t, n) {
        return (
          t === !1
            ? ue.removeAttr(e, n)
            : (_e && Me) || !qe.test(n)
            ? e.setAttribute((!Me && ue.propFix[n]) || n, n)
    ...
    ue.support.hrefNormalized ||
      (ue.each(["href", "src", "width", "height"], function (e, n) {
        ue.attrHooks[n] = ue.extend(ue.attrHooks[n], {
          get: function (e) {
    ...
    ue.support.optSelected ||
      (ue.propHooks.selected = ue.extend(ue.propHooks.selected, {
        get: function (e) {
          var t = e.parentNode;
          return (
  ...
  (ue.event = {
        ...
        for (
          r.handler && ((l = r), (r = l.handler), (o = l.selector)),
            ...
            (f = y.handle) ||
              ((f = y.handle =
                function (e) {
                  return typeof ue === V || (e && ue.event.triggered === e.type)
                    ? t
                    : ue.event.dispatch.apply(f.elem, arguments);
                }),
              (f.elem = e)),
            n = (n || "").match(ce) || [""],
            u = n.length;
    ...
    trigger: function (n, r, i, o) {
      ...
      if (
        ...
        if (!o && !c.noBubble && !ue.isWindow(i)) {
          for (
            l = c.delegateType || h, Pe.test(l + h) || (u = u.parentNode);
            u;
            u = u.parentNode
          )
            d.push(u), (f = u);
        ...
        for (p = 0; (u = d[p++]) && !n.isPropagationStopped(); )
          (n.type = p > 1 ? l : c.bindType || h),
            (a =
              (ue._data(u, "events") || {})[n.type] && ue._data(u, "handle")),
            a && a.apply(u, r),
            (a = s && u[s]),
            a &&
              ue.acceptData(u) &&
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = ue.event.handlers.call(this, e, l), n = 0;
          ...
          for (
            ...
            (!e.namespace_re || e.namespace_re.test(i.namespace)) &&
              ...
              (e.data = i.data),
              (r = (
                (ue.event.special[i.origType] || {}).handle || i.handler
              ).apply(o.elem, u)),
              r !== t &&
                (e.result = r) === !1 &&
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a =
            Be.test(i) ? this.mouseHooks : Oe.test(i) ? this.keyHooks : {}),
              ...
              var n = e.target,
                r =
                  ue.nodeName(n, "input") || ue.nodeName(n, "button")
                    ...
                    : t;
              r &&
                !ue._data(r, "submitBubbles") &&
                (ue.event.add(r, "submit._submit", function (e) {
                  e._submit_bubble = !0;
                }),
      ...
      function x(e, t, n, r) {
        ...
        if (!r && 1 === l.length) {
          if (
            ...
            if (((t = C.find.ID(a.matches[0].replace(xe, Te), t)[0]), !t))
              return n;
      ...
      (E = a.isXML =
            ...
            return r !== L && 9 === r.nodeType && r.documentElement
              ? ((L = r),
                ...
                (C.find.CLASS =
                  W.getByClassName &&
                  function (e, n) {
                    return typeof n.getElementsByClassName === V || q
                      ? t
        ...
        (a.matchesSelector = function (e, t) {
          if (
            ...
            (t = t.replace(be, "='$1']")),
            !(!W.matchesSelector || q || (_ && _.test(t)) || M.test(t)))
          )
            try {
              var n = F.call(e, t);
              if (
  ...
  ue.fn.extend({
    find: function (e) {
      ...
      return (
        (n = this.pushStack(i > 1 ? ue.unique(n) : n)),
    ...
    is: function (e) {
      return (
        ...
        ("string" == typeof e
          ? ze.test(e)
            ? ue(e, this.context).index(this[0]) >= 0
            : ue.filter(e, this).length > 0
    ...
    closest: function (e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          a = ze.test(e) || "string" != typeof e ? ue(e, t || this.context) : 0;
        i > r;
        r++
      )
        for (
      ...
      function (e, t) {
        ue.fn[e] = function (n, r) {
          ...
          return (
            ...
            (i = this.length > 1 && !Xe[e] ? ue.unique(i) : i),
    ...
    ue.fn.extend({
      ...
      remove: function (e, t) {
        for (var n, r = 0; null != (n = this[r]); r++)
          (!e || ue.filter(e, [n]).length > 0) &&
            (t || 1 !== n.nodeType || ue.cleanData(b(n)),
            n.parentNode &&
              (t && ue.contains(n.ownerDocument, n) && m(b(n, "script")),
          ...
          function (e) {
            ...
            if (
              !(
                "string" != typeof e ||
                et.test(e) ||
                (!ue.support.htmlSerialize && Ye.test(e)) ||
                (!ue.support.leadingWhitespace && Je.test(e)) ||
              ...
              try {
                for (; i > r; r++)
                  (n = this[r] || {}),
                    1 === n.nodeType &&
                      (ue.cleanData(b(n, !1)), (n.innerHTML = e));
                n = 0;
              } catch (o) {}
            }
      ...
      replaceWith: function (e) {
        var t = ue.isFunction(e);
        return (
          t || "string" == typeof e || (e = ue(e).not(this).detach()),
      ...
      domManip: function (e, n, r) {
        ...
        if (
          v ||
          (!(1 >= f || "string" != typeof y || ue.support.checkClone) &&
            nt.test(y))
        )
        ...
        if (
          f &&
          ((l = ue.buildFragment(e, this[0].ownerDocument, !1, this)),
          (i = l.firstChild),
          1 === l.childNodes.length && (l = i),
          i)
        ) {
          for (
            n = n && ue.nodeName(i, "tr"),
              s = ue.map(b(l, "script"), h),
              a = s.length;
            f > c;
            c++
          )
            (o = l),
              c !== m &&
                ((o = ue.clone(o, !0, !0)), a && ue.merge(s, b(o, "script"))),
              r.call(
                n && ue.nodeName(this[c], "table")
                  ? d(this[c], "tbody")
                  : this[c],
                o,
                c
          ...
          if (a)
            for (
              u = s[s.length - 1].ownerDocument, ue.map(s, g), c = 0;
              a > c;
              c++
            )
              (o = s[c]),
                rt.test(o.type || "") &&
                  !ue._data(o, "globalEval") &&
                  ue.contains(u, o) &&
                  (o.src
                    ? ue.ajax({
                        url: o.src,
    ...
    ue.extend({
      ...
      buildFragment: function (e, t, n, r) {
            ...
            if ("object" === ue.type(o)) ue.merge(h, o.nodeType ? [o] : o);
              ...
              if (
                ...
                for (
                  ...
                  ue.nodeName((l = o.childNodes[i]), "tbody") &&
                    !l.childNodes.length &&
                    o.removeChild(l);
              for (
                ue.merge(h, s.childNodes), s.textContent = "";
                s.firstChild;
        ...
        for (
          ...
          if (
            (!r || -1 === ue.inArray(o, r)) &&
            ((a = ue.contains(o.ownerDocument, o)),
  ...
  ue.fn.extend({
    ...
    ue.extend({
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var o,
            ...
            l = e.style;
          if (
            ((n = ue.cssProps[u] || (ue.cssProps[u] = T(l, u))),
          ...
          if (
            ...
            "string" === a &&
              (o = bt.exec(r)) &&
              ((r = (o[1] + 1) * o[2] + parseFloat(ue.css(e, n))),
              (a = "number")),
            !(
              null == r ||
              ("number" === a && isNaN(r)) ||
              ("number" !== a || ue.cssNumber[u] || (r += "px"),
      ...
      css: function (e, n, r, i) {
        var o,
          ...
          u = ue.camelCase(n);
        return (
          (n = ue.cssProps[u] || (ue.cssProps[u] = T(e.style, u))),
          (s = ue.cssHooks[n] || ue.cssHooks[u]),
          s && "get" in s && (a = s.get(e, !0, r)),
          a === t && (a = ft(e, n, i)),
          "normal" === a && n in wt && (a = wt[n]),
          "" === r || r
            ? ((o = parseFloat(a)), r === !0 || ue.isNumeric(o) ? o || 0 : a)
            : a
        );
      },
    ...
    ue.each(["height", "width"], function (e, n) {
      ue.cssHooks[n] = {
        get: function (e, r, i) {
          return r
            ? 0 === e.offsetWidth && gt.test(ue.css(e, "display"))
              ? ue.swap(e, Tt, function () {
                  return E(e, n, i);
                })
              : E(e, n, i)
            : t;
            ...
            r
              ? k(
                  ...
                  ue.support.boxSizing &&
                    "border-box" === ue.css(e, "boxSizing", !1, i),
                  i
                )
              : 0
          );
    ...
    ue(function () {
      ue.support.reliableMarginRight ||
        (ue.cssHooks.marginRight = {
          get: function (e, n) {
            return n
              ? ue.swap(e, { display: "inline-block" }, ft, [e, "marginRight"])
              : t;
          },
        }),
          ...
          ue.each(["top", "left"], function (e, n) {
            ue.cssHooks[n] = {
              get: function (e, r) {
                return r
                  ? ((r = ft(e, n)),
                    vt.test(r) ? ue(e).position()[n] + "px" : r)
                  : t;
              },
            };
          });
  ...
  (Dt = Rt.exec(Lt.toLowerCase()) || []),
    ...
    ue.each(["get", "post"], function (e, n) {
      ue[n] = function (e, r, i, o) {
        return (
          ue.isFunction(r) && ((o = o || i), (i = r), (r = t)),
          ue.ajax({ url: e, type: n, dataType: o, data: r, success: i })
        );
      };
    }),
    ue.extend({
      ...
      ajax: function (e, n) {
        function r(e, n, r, i) {
          ...
          2 !== x &&
            ...
            (w.status = e),
            (w.statusText = (n || N) + ""),
            o ? g.resolveWith(d, [f, N, w]) : g.rejectWith(d, [w, N, v]),
            w.statusCode(y),
            (y = t),
            l && h.trigger(o ? "ajaxSuccess" : "ajaxError", [w, p, o ? f : v]),
            m.fireWith(d, [w, N]),
            l &&
        ...
        (l = p.global),
          ...
          p.ifModified &&
            (ue.lastModified[a] &&
              w.setRequestHeader("If-Modified-Since", ue.lastModified[a]),
            ue.etag[a] && w.setRequestHeader("If-None-Match", ue.etag[a])),
    ...
    ue.ajaxTransport("script", function (e) {
      if (e.crossDomain) {
        var n,
          r = Y.head || ue("head")[0] || Y.documentElement;
        return {
          send: function (t, i) {
              ...
              u.send((n.hasContent && n.data) || null),
                ...
                n.async
                  ? 4 === u.readyState
                    ? setTimeout(r)
                    : ((a = ++Gt),
                      Qt && (Yt || ((Yt = {}), ue(e).unload(Qt)), (Yt[a] = r)),
        ...
        function (e, t) {
          ...
          if (o) {
            if (
              ...
              do (u = u || ".5"), (s /= u), ue.style(i.elem, e, s + r);
  ...
  (n.special.smartresize = {
    ...
    (i.Mason.prototype = {
      ...
      _getBricks: function (t) {
        var i = this._filterFindBricks(t)
      ...
      _create: function (s) {
        ...
        this.originalStyle = { height: e.height || "" };
        ...
        setTimeout(function () {
          ...
          this.options.isResizable &&
            i(t).bind("smartresize.masonry", function () {
              r.resize();
            }),
          this.reloadItems();
      },
      ...
      layout: function (t, i) {
        ...
        var n = {};
        if (
          ((n.height = Math.max.apply(Math, this.colYs)),
          this.options.isFitWidth)
        ) {
          var o = 0;
          for (s = this.cols; --s && 0 === this.colYs[s]; ) o++;
          n.width =
            (this.cols - o) * this.columnWidth - this.options.gutterWidth;
        }
        ...
        for (s = 0, e = this.styleQueue.length; s < e; s++)
          (h = this.styleQueue[s]), h.$el[a](h.style, r);
      ...
      _getColumns: function () {
        ...
        (this.columnWidth = this.isFluid
          ? this.options.columnWidth(i)
          : this.options.columnWidth || this.$bricks.outerWidth(!0) || i),
          (this.columnWidth += this.options.gutterWidth),
          (this.cols = Math.floor(
            (i + this.options.gutterWidth) / this.columnWidth
          )),
      ...
      _placeBrick: function (t) {
        var s,
          ...
          a = i(t);
        if (
          ((s = Math.ceil(a.outerWidth(!0) / this.columnWidth)),
          (s = Math.min(s, this.cols)),
          1 === s)
        )
          n = this.colYs;
        else
          for (e = this.cols + 1 - s, n = [], h = 0; h < e; h++)
            (o = this.colYs.slice(h, h + s)), (n[h] = Math.max.apply(Math, o));
        for (
          var r = Math.min.apply(Math, n), l = 0, c = 0, u = n.length;
          c < u;
          c++
        )
          if (n[c] === r) {
    ...
    (i.fn.imagesLoaded = function (t) {
      ...
      function e(t) {
        ...
        n.src !== a &&
          i.inArray(n, r) === -1 &&
          (r.push(n),
          --h <= 0 && (setTimeout(s), o.unbind(".imagesLoaded", e)));
      }
      var n = this,
  ...
  i.fn.masonry = function (t) {
    if ("string" == typeof t) {
      ...
      this.each(function () {
        ...
        return e
          ? i.isFunction(e[t]) && "_" !== t.charAt(0)
            ? void e[t].apply(e, s)
            : void o("no such method '" + t + "' for masonry instance")
          : void o(
      ...
      this.each(function () {
        ...
        s
          ? (s.option(t || {}), s._init())
          : i.data(this, "masonry", new i.Mason(t, this));
      });
    return this;
  };
})(window, jQuery);
!(function (t, i) {
  var e = {
      ...
      load_header: function () {
        var e = t(".header-image");
        if (i.$body.hasClass("iframe") || i.$body.hasClass("touch"))
          e.css({ opacity: 1 }).addClass("loaded");
        else {
          var s = e.data("bg-image"),
            o = new Image();
      ...
      like_button: function () {
        t("#posts, .related-posts").on(
          "mouseenter touchstart",
          ".like_button",
          function (i) {
            var e = t(i.currentTarget);
            e.hasClass("liked") || e.addClass("interacted");
          }
        );
      },
      link_color: function () {
        var t = i.Utils.hex_to_hsv(i.ACCENT_COLOR),
          e = i.Utils.hex_to_hsv(i.BACKGROUND_COLOR);
        t.s < 0.2 &&
          t.v > 0.8 &&
          (i.$body.addClass("light-accent"),
          e.s < 0.2 && e.v > 0.8 && i.$body.addClass("light-on-light")),
          t.v < 0.2 && e.v < 0.2 && i.$body.addClass("dark-on-dark");
      },
      description_color: function () {
        var e = t(".title-group .description");
        if (e.length) {
          var s = i.Utils.hex_to_rgb(i.TITLE_COLOR);
          e.css({ color: "rgba(" + s.r + "," + s.g + "," + s.b + ", 0.7)" });
        }
      },
      devices: function () {
        ...
        (this.supports_app_nag = !1),
          this.is_touch_device() &&
            ...
            i.$body.hasClass("permalink") ||
              setTimeout(function () {
                window.scrollTo(0, 1);
              }, 1));
        var s = (e.match(/Android\s([0-9\.]*)/) || [])[1];
        e.match(/(iPhone|iPod|iPad)/)
          ? (this.ios(), (this.supports_app_nag = !0))
          : s &&
            ((this.supports_app_nag = !0),
            i.$body.addClass("android"),
            parseFloat(s) < 4.4 && i.$body.addClass("android-lt-4-4")),
          this.supports_app_nag &&
            this.supports_local_storage() &&
            "true" !== localStorage.getItem("has-seen-app-nag") &&
            (i.$body.addClass("catch-share-events"), this.prepare_app_nag()),
          t("#page").on(
            "click",
            "a.open-in-app",
            t.proxy(function (i) {
              ...
              var e,
                ...
                n = t(i.currentTarget),
                a = n.data("post");
              n.hasClass("related-post-cta") &&
                ((e = "blog_related_posts_cta"),
                (s = n.data("cta-variant")),
                (o = t(".related-posts > article").length)),
                this.open_in_app(a, e, s, o);
            }, this)
          );
      },
      ...
      prepare_app_nag: function () {
        t(".catch-share-events").on(
          "click.shareEvents",
          ".reblog-control, .like-control",
          t.proxy(function (i) {
            i.preventDefault();
            var e = t(i.currentTarget).closest("article").data("post-id");
            this.open_app_nag(e);
          }, this)
        );
        var e = t(".app-nag");
        e.on(
          ...
          t.proxy(function (t) {
            i.$body.removeClass("show-app-nag"), this.close_app_nag(!1);
          }, this)
        ),
          e.on(
            "click",
          ...
          e.on(
            "click",
            ".app-nag-app-store-link",
            t.proxy(function (i) {
              this.close_app_nag(!0),
                this.open_in_app(
                  t(i.currentTarget).data("id"),
                  "blog_engagement_popover"
                );
            }, this)
          );
      },
      open_app_nag: function (e) {
        i.$body.addClass("show-app-nag"),
          t(".app-nag-app-store-link").data("id", e);
      },
      close_app_nag: function (e) {
        e === !1 &&
          (t(".catch-share-events").off("click.shareEvents"),
          localStorage.setItem("has-seen-app-nag", !0)),
          i.$body.removeClass("show-app-nag catch-share-events");
      },
      ios: function () {
        i.$body.addClass("ios"), (this.is_ios = !0);
      },
      open_in_app: function (i, e, s, o) {
        (e = e || "blog_popover"), (s = s || ""), (o = o || "");
        var n =
          "//www.tumblr.com/open/app?referrer=" +
          e +
          "&variant=" +
          s +
          "&num_related_posts=" +
          o +
          "&app_args=" +
          encodeURIComponent("blog?blogName=") +
          t("body").data("urlencoded-name");
        return (
          i && (n += encodeURIComponent("&postID=" + i)),
          this.is_ios
            ? void this.open_in_app_or_store(n, e)
            : void (document.location = n)
        );
      },
      open_in_app_or_store: function (t, i) {
        var e = "itms-apps://itunes.com/apps/tumblr/tumblr";
        "blog_engagement_popover" === i && (e += "?pt=212308&ct=optica-popup");
        var s =
          document.getElementById("app_protocol_check") ||
          document.createElement("iFrame");
        s.setAttribute("id", "app_protocol_check"),
      ...
      rgb_to_hex: function (t, i, e) {
        return (
          "#" + ((1 << 24) + (t << 16) + (i << 8) + e).toString(16).slice(1)
        );
      },
      ...
      rgb_to_hsv: function (t, i, e) {
        var s = Math.min(Math.min(t, i), e),
          o = Math.max(Math.max(t, i), e),
          n = o - s,
      ...
      hsv_to_hex: function (e, s, o) {
        var n = i.Utils.hsv_to_rgb(e, s, o),
    ...
    o = {
      ...
      event_loop: function () {
        i.$win.on(
          "scroll.Eventor:next-frame",
          t.proxy(function () {
            this.tick || (s(t.proxy(this.next_frame, this)), (this.tick = !0));
          }, this)
        ),
          t(".notes-wrapper .notes").on(
            "scroll.Eventor:next-frame",
            t.proxy(function () {
              this.tick ||
                (s(t.proxy(this.popover_frame, this)), (this.tick = !0));
            }, this)
          );
      },
      next_frame: function (t) {
        i.$win.trigger("Eventor:scroll"), (this.tick = !1);
      },
      popover_frame: function (t) {
        i.$win.trigger("Eventor:scroll:popover"), (this.tick = !1);
      },
    },
    n = function (i, e) {
      return this instanceof n
        ? ((this.el = "string" == typeof i ? t(i).get(0) : i),
          (this.$el = t(i)),
          (this.options = e),
  ...
  (n.prototype = {
    ...
    bind_events: function () {
      this.$el.on(
        "mouseenter",
        this.trigger,
        t.proxy(this.__mouse_enter, this)
      ),
        this.$el.on(
          "mouseleave",
          this.trigger,
          t.proxy(this.__mouse_leave, this)
        );
    },
    show: function (i) {
    ...
    hide: function (e) {
      i.Popmenu.hide_all(),
        (this.leave_delay = setTimeout(
          t.proxy(function () {
            e.removeClass("active"), clearTimeout(this.leave_delay);
          }, this),
          this.config.forgiveness_delay
        ));
    },
  }),
    (n.defaults = { forgiveness_delay: 0 }),
  ...
  a.prototype = {
    ...
    parallax: function () {
      var t = i.$win.scrollTop(),
        e = Math.round(t * this.inertia);
      if (!(e > 400)) {
        if (this.options.animate_opacity) {
          var s = t * this.options.opacity_inertia,
            o = (100 - s) / 100;
          o < 0 && (o = 0), this.$el.css({ opacity: o });
        }
        this.options.animate_position &&
          this.$el.css({ transform: "translate3d(0," + e + "px, 0)" });
      }
    },
  };
  var r = function (i, e, s) {
    return this instanceof r
      ? ((this.el = "string" == typeof i ? t(i).get(0) : i),
        (this.$el = t(i)),
        (this.config = t.extend({}, r.defaults, e)),
  ...
  (r.prototype = {
    get_items: function () {
      ...
      for (var i = 0, e = this.items.length; i < e; i++)
  ...
  (h.prototype = {
    __document_click: function (i) {
      var e = t(i.target);
      this.$popover &&
        this.$popover.hasClass("active") &&
        !this.$el.has(e.parents(this.config.container)).length &&
        !e.is(this.config.ignore) &&
        this.hide();
    },
    ...
    __trigger_click: function (i) {
      i.preventDefault(),
        ...
        this.options &&
          this.options.hash &&
          (document.location.hash = this.options.hash),
        ...
        this.$popover.length ||
          (this.$popover = this.$trigger
            .parents("footer")
            .find(this.config.popover)),
    ...
    _check_offset: function () {
      Math.abs(this.scroll_offset - i.$win.scrollTop()) >
        this.config.scroll_distance &&
        (this.$search_input.is(":focus") || this.hide());
    },
    ...
    unbind_events: function () {
      this.$el.off("click", this.trigger, this.events.trigger_click),
        this.$el.off(
          "mouseenter",
          this.popover,
          this.events.popover_mouseenter
        ),
        this.$el.off(
          "mouseleave",
          this.popover,
          this.events.popover_mouseleave
        ),
        ...
        setTimeout(
          t.proxy(function () {
            i.$body.addClass(this.config.body_active_class),
              ...
              this.config.close_on_scroll &&
                i.$win.on("Eventor:scroll", this.events.offset_scroll);
          }, this),
          10
        );
    },
  ...
  var l = {
      ...
      _near_bottom: function () {
        return (
          i.$notesInner[0].scrollHeight - i.$notesInner.scrollTop() <
          3 * i.$notes.height()
        );
      },
      init: function () {
        (i.LOADING_NOTES = !1),
          (this.events = { scroll: t.proxy(this.__popover_scroll, this) }),
          this.bind_events();
      },
      bind_events: function () {
      ...
      load_notes: function () {
        i.LOADING_NOTES ||
          ((i.LOADING_NOTES = !0), t(".more_notes_link").trigger("click"));
      },
    },
    c = {
      $elements: [],
      ...
      cached_cards: {},
      hover_timeout: null,
      __hover_begin: function (i) {
        window.clearTimeout(this.hover_timeout);
        var e = i.target.dataset.blogCardUsername;
        if (e) {
          var s = this.$card_holder;
          this.get_card_html(e, function (e) {
            s.html(e),
              t(i.target).parents("article").append(s.get(0)),
              s.fadeIn();
          });
        }
      },
      __hover_stop: function (t) {
        var i = this.$card_holder;
        this.hover_timeout = window.setTimeout(function () {
          i.fadeOut();
        }, 500);
      },
      __hover_card_begin: function (t) {
        window.clearTimeout(this.hover_timeout);
      },
      __hover_card_stop: function (t) {
        var i = this.$card_holder;
        this.hover_timeout = window.setTimeout(function () {
          i.fadeOut();
        }, 500);
      },
      get_card_html: function (i, e) {
        var s = this.cached_cards;
        return s[i]
          ? e(s[i])
          : void t
              .get("/blog_card/" + i)
      ...
      init: function () {
        return (
          !!i.NU_OPTICA_BLOG_CARDS &&
          ((this.$card_holder = t("<div></div>")),
          (this.$card_holder[0].style.display = "none"),
          this.$card_holder.addClass("blog-card-popover"),
          (this.events = {
            hover_begin: t.proxy(this.__hover_begin, this),
            hover_stop: t.proxy(this.__hover_stop, this),
            hover_card_begin: t.proxy(this.__hover_card_begin, this),
            hover_card_stop: t.proxy(this.__hover_card_stop, this),
          }),
          void this.bind_events())
        );
      },
      bind_triggers: function (t) {
        if (!this.events) return !1;
        var t = t.find("[data-blog-card-username]");
        t.on("mouseenter", this.events.hover_begin),
          t.on("mouseleave", this.events.hover_stop);
      },
      bind_events: function () {
        this.bind_triggers(i.$win_body),
          this.$card_holder.on("mouseenter", this.events.hover_card_begin),
          this.$card_holder.on("mouseleave", this.events.hover_card_stop);
      },
    },
    _ = {
      init: function () {
        return (
          ...
          (this.$inlineNav = t(".inline-nav")),
          (this.$navItems = t(".inline-nav .nav-item")),
          (this.$links = t(".inline-nav a")),
          (this.events = {
            dragScroll: t.proxy(this.__drag_scroll, this),
            dragStart: t.proxy(this.__drag_start, this),
            dragMove: t.proxy(this.__drag_move, this),
            dragEnd: t.proxy(this.__drag_end, this),
            dragLinkHandler: t.proxy(this.__drag_link_handler, this),
            windowResize: t.proxy(
              i.Utils.debounce(this.__window_resize, 100),
              this
            ),
          }),
          (this.docEvents = {
            dragMove: t.proxy(this.__drag_move, this),
            dragReset: t.proxy(this.__drag_reset, this),
            dragCheckMouseOut: t.proxy(this.__drag_check_mouse_out, this),
          }),
          this._bind_events(),
          this._drag_setup(),
          this
      ...
      _drag_setup: function () {
        this._drag_overflowing() && this.$inlineNav.addClass("draggable");
      },
      _bind_events: function () {
        this.$inlineNav.on("mousedown", this.events.dragStart),
          this.$inlineNav.on("mousemove", this.events.dragMove),
          this.$inlineNav.on("mouseup", this.events.dragEnd),
          this.$links.on("click", this.events.dragLinkHandler),
          i.$win.on("resize orientationchange", this.events.windowResize);
      },
      _drag_bind_doc_events: function () {
        i.$doc.on("mousemove.linksDraggable", this.docEvents.dragMove),
          i.$doc.on("mouseup.linksDraggable", this.docEvents.dragReset),
          i.$doc.on("mouseout", this.docEvents.dragCheckMouseOut);
      },
      _drag_unbind_doc_events: function () {
        i.$doc.off("mousemove.linksDraggable"),
          i.$doc.off("mouseup.linksDraggable"),
          i.$doc.off("mouseout");
      },
      _drag_overflowing: function () {
        return this.$inlineNav.width() < this.$inlineNav.get(0).scrollWidth;
      },
      _drag_set: function (t) {
        this.$navItems.css("transform", "translate(" + t + "px, 0)");
      },
      _drag_reset_position: function () {
        var t = this._draggable.currentX + this._draggable.dragX,
          i = this.$inlineNav.width() - this.$inlineNav.get(0).scrollWidth;
        t > 0
          ? (this._drag_set(0), (this._draggable.currentX = 0))
          : t < i
          ? (this._drag_set(i), (this._draggable.currentX = i))
          : (this._draggable.currentX = t);
      },
      __drag_check_mouse_out: function (t) {
        var i = t.relatedTarget || t.toElement;
        (i && "HTML" !== i.nodeName && "IFRAME" !== i.nodeName) ||
          this.__drag_end(t);
      },
      __drag_link_handler: function (t) {
        this._draggable.dragging && (t.stopPropagation(), t.preventDefault());
      },
      __drag_start: function (t) {
        t.preventDefault(),
          this._draggable.dragging ||
            this._draggable.pointerDown ||
            !this._drag_overflowing() ||
            ((this._draggable.pointerDown = !0),
            this.$inlineNav.addClass("dragging"),
            (this._draggable.pageX =
              "pageX" in t ? t.pageX : t.originalEvent.touches[0].pageX),
            this._drag_bind_doc_events());
      },
      __drag_move: function (t) {
        if (this._draggable.pointerDown) {
          t.preventDefault(),
            t.stopPropagation(),
            (this._draggable.dragging = !0),
            (this._draggable.dragX =
              ("clientX" in t
                ? t.clientX
                : t.originalEvent.touches[0].clientX) - this._draggable.pageX);
          var i = this._draggable.currentX + this._draggable.dragX;
          this._drag_set(i);
        }
      },
      __drag_end: function (i) {
        i.preventDefault(),
          i.stopPropagation(),
          setTimeout(t.proxy(this.__drag_reset, this), 100);
      },
      __drag_reset: function () {
        (this._draggable.dragging || this._draggable.pointerDown) &&
          ((this._draggable.dragging = !1),
          (this._draggable.pointerDown = !1),
          this._drag_reset_position(),
          (this._draggable.dragX = 0),
          this.$inlineNav.removeClass("dragging"),
          this._drag_unbind_doc_events());
      },
      __window_resize: function () {
        this._drag_overflowing()
          ? this.$inlineNav.hasClass("draggable") ||
            this.$inlineNav.addClass("draggable")
          : (this.$inlineNav.removeClass("draggable"),
            this.$navItems.removeAttr("style"),
            (this._draggable.currentX = 0),
            (this._draggable.pageX = 0));
      },
    },
    d = {
      __window_scroll: function () {
        this.determine_fixed_state();
      },
      determine_fixed_state: function () {
        var t = this.$headerWrapper.outerHeight(!0),
          e = this.$inlineNav.outerHeight(!0) - this.$inlineNav.outerHeight(),
          s = t - this.iframeHeight + e,
          o = this.$navbar.outerHeight(!0);
        i.$win.scrollTop() >= s && !this.$navbar.hasClass("nav-fixed")
          ? (this.$navbar.addClass("nav-fixed"),
            this.$posts.css("margin-top", "+=" + o))
          : i.$win.scrollTop() < s &&
            this.$navbar.hasClass("nav-fixed") &&
            (this.$navbar.removeClass("nav-fixed"),
            this.$posts.css("margin-top", "-=" + o));
      },
      init: function (i) {
        return (
          (this.iframeHeight = i ? i.unifiedIframeHeight : 54),
          (this.$navbar = t(".nav-wrapper")),
          (this.$posts = t("#posts")),
          (this.$inlineNav = t(".inline-nav")),
          (this.$headerWrapper = t(".header-wrapper")),
          (this.events = { scroll: t.proxy(this.__window_scroll, this) }),
          this.bind_events(),
          this.determine_fixed_state(),
          this
        );
      ...
      bind_events: function () {
        i.$win.on("Eventor:scroll", this.events.scroll);
      },
    },
    p = function (e, s) {
      return this instanceof p
        ? ((this.el = "string" == typeof e ? t(e).get(0) : e),
          (this.$el = t(e)),
          (this.config = t.extend({}, p.defaults, s)),
          this.config.$pagination || this.config.$pagination.length
            ? ((this.current_page =
                this.config.$pagination.data("current-page")),
              ...
              this.base_url &&
                (this.base_url =
                  this.base_url.substring(0, this.base_url.lastIndexOf("/")) +
                  "/"),
              (this.loading_data = !1),
              (this.is_scrolling = !1),
              (this.body_timeout = -1),
              ...
              this.bind_events(),
              this.config.endless_scrolling && this.config.$pagination.length
                ? (this.config.$pagination.addClass("invisible"),
                  (this.init = !0))
                : (this.init = !1),
              (i.$body.hasClass("touch") || this.$html.hasClass("lt-ie9")) &&
                ((i.GRID_LAYOUT = !1),
  ...
  (p.prototype = {
    __document_keydown: function (e) {
      var s = e.charCode ? e.charCode : e.keyCode,
        o = e ? e.target : window.event.srcElement;
      t(o).is("input:focus") ||
        (27 === s && i.Popmenu.hide_all(),
        190 === s && i.$win_body.animate({ scrollTop: 0 }),
        this.is_grid_layout ||
          i.$body.hasClass("permalink") ||
          (74 === s ? this.next_post() : 75 === s && this.previous_post()));
    },
    __window_resize: function () {
      this.set_body_type(),
    ...
    __window_scroll: function () {
      i.$body.hasClass("touch") && this.update_body(),
        this.is_scrolling ||
          (i.$body.addClass("is-scrolling"), (this.is_scrolling = !0)),
        clearTimeout(this.body_timeout),
        (this.body_timeout = setTimeout(
          t.proxy(function () {
            i.$body.removeClass("is-scrolling"), (this.is_scrolling = !1);
          }, this),
          200
        )),
        this.init &&
    ...
    _set_post_bounds: function (i) {
      var e = i.offset().top,
        s = i.outerHeight(),
        o = e + s;
      return t.data(i[0], "offsets", { top: e, height: s, bottom: o });
    },
    _in_view: function (t) {
      var e,
        s = i.$win.scrollTop();
      this.window_height = this.window_height || i.$win.height();
      var o = s + this.window_height;
      return (
        (e = this._get_post_bounds(t)),
        e || (e = this._set_post_bounds(t)),
        !(e.bottom + this.window_height < s || e.top > o + this.window_height)
      );
    },
    _snooze: function (t) {
      t.addClass("snooze");
    ...
    _append_new_items: function (e) {
      ...
      n.each(
        t.proxy(function (i, e) {
          var s = t(e).find(".like_button").data("post-id");
          s && a.push(s);
        }, this)
      ),
        c.bind_triggers(o),
        t(s).append(n),
        this.updateMedia(o),
        (i.GRID_LAYOUT && this.is_grid_layout) ||
        i.$body.hasClass("following-page") ||
        i.$body.hasClass("likes-page")
          ? n.imagesLoaded(
              t.proxy(function () {
                o.iframesLoaded(
                  { selector: ".post-content iframe" },
                  t.proxy(function () {
                    this.config.$target.masonry("appended", n, !0),
                      (this.loading_data = !1),
          ...
          : ((this.loading_data = !1),
            this.update_spotify(o),
            i.$body.hasClass("narrow") && this.upscale_images(o),
            n.fadeTo(300, 1),
            this.hide_loader()),
        a && a.length > 0 && window.Tumblr.LikeButton.get_status_by_post_ids(a),
        window.ga &&
        ...
        i.$win.trigger("next_page_loaded", e);
    },
    ...
    next_post: function () {
      ...
      for (var t in this.post_positions) {
        ...
        i > this.current_position + 12 &&
          (i < this.go_to_position || !this.go_to_position) &&
          (this.go_to_position = i);
      }
      this.animate();
    },
    ...
    set_body_type: function () {
      ...
      i.$body.hasClass("following-page") ||
      i.$body.hasClass("likes-page")
        ? (i.$body.removeClass("slender"),
          ((i.GRID_LAYOUT && i.$body.hasClass("index-page")) ||
            i.$body.hasClass("following-page") ||
            i.$body.hasClass("likes-page")) &&
            (i.$body.addClass("grid"), this.set_masonry()))
        : (i.$body.addClass("slender").removeClass("grid"),
          i.GRID_LAYOUT &&
            this.is_grid_layout &&
    ...
    update_body: function () {
      this._near_top()
        ? (i.$body.addClass("top"), i.$body.removeClass("below-header"))
        : (i.$body.removeClass("top"), i.$body.addClass("below-header"));
    },
    ...
    update_post_positions: function () {
      ...
      t("#posts article").each(function () {
        var e = t(this).data("post-id");
        i[e] = t(this).offset().top;
      }),
    ...
    bind_events: function () {
      this.$el.on("Eventor:scroll", t.proxy(this.__window_scroll, this)),
        this.$el.on(
          ...
          t.proxy(
            i.Utils.debounce(this.__window_resize, this.config.resizeDelay),
            this
          )
        ),
    ...
    update_spotify: function (i) {
      var e = t(".audio_container").width(),
        s = e + 80,
        o =
          i && i.length
            ? t(".spotify_audio_player", i)
            : t(".spotify_audio_player");
      e > 500
        ? o.each(function () {
            t(this).css({ width: e, height: s }),
              t(this).attr("src", t(this).attr("src"));
          })
        : o.each(function () {
            t(this).css({ width: e }), t(this).attr("src", t(this).attr("src"));
          });
    },
    upscale_images: function (i) {
      var e =
        i && i.length
          ? t(".photo figure:not(.high-res)", i)
          : t(".photo figure:not(.high-res)");
      e.each(function () {
    ...
    updateMedia: function (i) {
      var e =
          ".like_toggle, .twitter-tweet, .tumblr-embed, .tumblr_audio_player, .spotify_audio_player, .instagram-media",
        s = "iframe:not(" + e + "), object, embed";
      (i && i.length) || (i = t("#page"));
      var o = i.find(s);
      o.each(function () {
        var i = t(this);
        if (i.data("aspect-ratio"))
          i.css({ height: i.width() * i.data("aspect-ratio") + "px" });
        else {
          var e = i.attr("height") || i.height(),
            s = i.attr("width") || i.width(),
            o = e / s;
          i.data("aspect-ratio", o),
            i.is(".photoset")
              ? i.width(i.parent().width())
              : i.css({ width: "100%" }),
            i.css({ height: i.width() * o + "px" });
        }
      });
      var n =
        window.Tumblr &&
        window.Tumblr.LivePhotos &&
        window.Tumblr.LivePhotos.create;
      n &&
        i.find("img[data-live-photo]").map(function (t, i) {
          return n(i);
        });
    },
    next_page: function () {
      return this.total_pages < this.next_page_number
        ? void this.hide_loader(!0)
        : ((this.loading_data = !0),
          this.show_loader(),
    ...
    (window.tumblrNotesInserted = function () {
      t(".more_notes_link").length
        ? (i.LOADING_NOTES = !1)
        : (i.DONE_LOADING_NOTES = !0);
    }),
    t(function () {
      i.Utils.init(), i.Eventor.init(), i.BlogCard.init();
      var e = t("body");
      e.hasClass("contain-header-image")
        ? new i.Parallaxer("body:not(.ie10, .touch) .parallax", {
            animate_opacity: !0,
            animate_position: !1,
          })
        : new i.Parallaxer("body:not(.ie10, .touch) .parallax");
      var s = new i.Pager(window, {
        $pagination: t("#pagination a"),
        $loader: t("#pagination .loader"),
        endless_scrolling: i.ENDLESS_SCROLLING,
      });
      t("body:not(.touch) #posts").drawer({ trigger: "article:not(.exposed)" }),
        t("#page").popmenu(),
        e.hasClass("permalink") &&
          (t("#page").popmenu({
            container: ".notes-pop-container",
            trigger: "#posts .main > article .post-notes",
          ...
          "#notes" === document.location.hash &&
            t("#posts .main > article .post-notes").click());
      var o = function (i, e) {
          var s = e.containerEl,
            o = t("#posts");
          o.each(function () {
            ...
            i.hasClass("masonry") && s && i.masonry("appended", s, !0);
          }),
            s.css("opacity", 1);
        },
        n = function () {
          i.$body.hasClass("following-page") && s.set_masonry();
        };
      window.Optica.$win.on("lrec_ads_placeholder_inserted", o),
        window.Optica.$win.on("lrec_ads_loaded", n),
        window.Optica.$win.on("init_sticky_nav", function (t, e) {
          i.StickyNav.init(e);
        }),
        window.Optica.SHOW_NAV && i.DraggableLinks.init(),
        i.NotesPager.init();
    });
